...
researchSteps:
  ...
  - label: "Researched the functional purpose of the tsuchime finish"
    detail: "Cross-referenced multiple cutlery sources on the tsuchime (hammered) forging technique used on Shun Premier to understand its stated functional purpose, distinct from its visual appearance."
  - label: "Checked handle design specifications across both lines"
    detail: "Confirmed via official Shun materials that both Classic and Premier use a D-shaped handle designed for right-handed use, with left-handed versions available only as a special order."
  - label: "Compared current official pricing for both lines"
    detail: "Reviewed official site pricing for Shun Classic and Shun Premier 8-inch chef's knives to establish the actual price gap at time of research."
sourcesChecked:
...
reviewLog:
  ...
  checks:
    - item: "Evidence Strength Rule"
      result: "pass"
      note: "全主張が適切なレベルで記述されている。LEVEL 1 は「per manufacturer specifications」で断定、LEVEL 2 は「commonly described as」「commonly cited as」等で修飾、LEVEL 3 は「We did not find evidence in the official Shun materials reviewed (August 2026)」で適切に記述済み。"
    - item: "禁止表現"
      result: "pass"
      note: "tested / hands-on / we tried / we used / we found + 物理体験系形容詞 等の禁止表現は一切なし。「Based on manufacturer specifications」「according to multiple cutlery sources reviewed for this guide」等の適切な表現が一貫して使用されている。"
    - item: "日本で人気だからロジック"
      result: "pass"
      note: "Japan Context は tsuchime フィニッシュの技法的背景・ハンドルのデザイン経緯・国内版の不在に関する事実で構成されており、「日本で人気だから推薦」のロジックは一切使用されていない。"
    - item: "Japan Context の独自性"
      result: "pass"
      note: "tsuchime フィニッシュの機能的背景は他の Shun 関連記事で未使用のユニーク視点。ハンドル設計経緯の事実は shun-knives-left-handed.md と重複する部分があるが CONTENT_RULES の「一般的事実の繰り返しは許容」の範囲内であり市場分析・流通構造のコピーには該当しない。"
    - item: "Final Verdict 推薦偏り"
      result: "pass"
      note: "verdict.rating は conditional。「スライスが多ければ Premier が worth the upgrade」「チョップが多ければ Classic で可」という具体的な使用条件が本文・verdict.summary の両方に明記されており推薦根拠が存在する。"
    - item: "Amazon 開示表記"
      result: "pass"
      note: "BaseLayout.astro フッターに「As an Amazon Associate, The Japan Filter earns from qualifying purchases.」の開示表記あり。ProductCard.astro の Amazon CTA 直下に「(paid link)」ラベルあり。両レイヤーで開示されている。"
    - item: "変動する数値の断定"
      result: "pass"
      note: "星評価・レビュー数・売上ランキングの具体的数値は一切使用なし。価格はすべて「MSRP」および「at time of research (August 2026)」と明記。ratings フィールドは verifiedAt のみで stars/reviewCount は未設定。"
  summary: "全7項目がパス。証拠強度は適切にレベル区分されており、禁止表現・日本人気ロジック・変動数値の問題なし。Japan Context は tsuchime フィニッシュを中心としたユニークな視点で構成されている。Amazon 開示はレイアウト・コンポーネントの両方で実装済み。"
ogImage: "/og/og-default.png"
products:
  - id: shun-classic-8in-chef-vs-premier
    brand: "Shun"
    award: "SMOOTH FINISH, LOWER PRICE"
    ...
    specs:
      ...
      - label: "Finish"
        value: "Smooth, polished Damascus pattern, per manufacturer specifications"
      - label: "Handle"
        value: "D-shaped, ebony PakkaWood, right-handed by default, per manufacturer specifications"
    origin:
      brandCountry: "Japan"
      madeIn: "Japan"
  ...
  - id: shun-premier-8in-chef
    brand: "Shun"
    award: "TSUCHIME FINISH, FOOD RELEASE"
    name: "Shun Premier 8-Inch Chef's Knife"
    priceTier: "$$$"
    priceNote: "MSRP $275; official site price $219.95 at time of research (August 2026)"
    setContents: "1 chef's knife, per manufacturer specifications"
    specs:
      - label: "Steel"
        value: "VG-MAX, per manufacturer specifications"
      - label: "Construction"
        value: "69-layer Damascus cladding, per manufacturer specifications"
      - label: "Finish"
        value: "Tsuchime (hand-hammered) texture, per manufacturer specifications"
      - label: "Handle"
        value: "D-shaped, walnut PakkaWood, right-handed by default, per manufacturer specifications"
    origin:
      brandCountry: "Japan"
      madeIn: "Japan"
      officialSeller: "Kai USA Ltd. / authorized Amazon.com listings"
    usNotes:
      - "Same core VG-MAX steel as Classic; the $38 premium is for the tsuchime finish and one additional Damascus layer"
      - "Like Classic, the standard handle is built for right-handed use; a left-handed version requires a special order through an authorized dealer"
    whyPicked:
      - "The tsuchime finish has a stated functional purpose (reduced food-to-blade contact), not just a different look"
      - "Confirmed identical VG-MAX steel to Classic per official specifications, isolating the finish as the primary functional difference"
    ratings:
      verifiedAt: "August 2026"
    amazon:
      url: "https://www.amazon.com/s?k=Shun+Premier+8+Inch+Chef+Knife"
    ctaLabel: "Check on Amazon"
japanContext:
  inJapan:
    - >-
      Tsuchime (槌目), meaning "hammer marks," is a traditional Japanese forging
      finish in which the blade surface is textured with small hammered indentations,
      according to multiple cutlery sources reviewed for this guide. The technique
      predates its use on export cutlery lines like Shun Premier and has a stated
      functional purpose: the uneven surface reduces the contact area between the
      blade and food, which is commonly described as helping thin slices release
      from the blade rather than sticking.
    - >-
