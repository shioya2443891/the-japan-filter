...
researchSteps:
  ...
  - label: "Compared gift-giving price bands"
    detail: "Focused on sets in the $50-100 range most commonly searched for wedding and housewarming gifts, comparing per-piece value across set sizes and series."
  - label: "Checked pattern availability and reviews"
    detail: "Cross-checked which patterns are consistently in stock and well-reviewed (4-star and above, 100+ verified purchases), rather than featuring discontinued or hard-to-restock lines."
...
sourcesChecked:
  ...
  - "Customer review patterns (verified purchases, 4-star and below filtered for durability signals)"
...
products:
  - id: colorwave-graphite-20pc
    ...
    usNotes:
      ...
      - "Open stock available --pieces can be added individually after the registry closes"
    whyPicked:
      - "Most complete out of the box --covers everyday dining without supplementary purchases"
  ...
  - id: colorwave-blue-16pc
    ...
    origin:
      ...
      officialSeller: "Noritake U.S.A., Inc."
    usNotes:
      - "Priced for individual gift-givers --no group coordination required"
    ...
    whyPicked:
      ...
      - "Practical registry listing --couple can supplement with open-stock pieces later"
    ratings:
      verifiedAt: "August 2026"
    amazon:
  ...
  - id: colorscapes-navy-16pc
    ...
    origin:
      ...
      officialSeller: "Noritake U.S.A., Inc."
    usNotes:
      - "Colorscapes is a step above Colorwave --heavier clay body, more deliberate finish"
      - "Recommended for couples with a considered kitchen aesthetic or who host regularly"
    whyPicked:
      - "Denser clay body than Colorwave --reviewers describe the weight as closer to restaurant-grade ware"
  ...
  - id: colorwave-graphite-pasta-5pc
    ...
    whyPicked:
      - "Functional standalone gift for pasta or salad households --practical and non-generic"
...
japanContext:
  inJapan:
    - >-
      ...
      importing Japanese ceramics to New York in 1876, and Nippon Toki Gomei Kaisha --      which later became Noritake --was established in Nagoya in 1904 specifically to
    ...
    - >-
      In Japan, Noritake's product line falls under the Western-style tableware category.
      ...
      and return gift recommendations. The retail and brand materials
      we reviewed showed a domestic catalog weighted toward bone china with decorative
      patterns, with department store channels as a primary retail context.
    - >-
