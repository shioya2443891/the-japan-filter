...
sourcesChecked:
  ...
  - "Japan domestic pricing sources (Zojirushi direct-sale channel, August 2026)"
...
reviewLog:
  ...
  checks:
    - item: "Evidence Strength Rule"
      result: "pass"
      note: "全主張が適切なレベルで記述されている。LEVEL 4の推論は「plausible reason」で明示的にラベル付けされている。"
    - item: "禁止表現"
      result: "pass"
      note: "tested / hands-on / we tried / we used / unboxed 等の禁止表現なし。"
    - item: "日本で人気だからロジック"
      result: "pass"
      note: "verdict の根拠はlid mechanismの機能的差異と用途別選択指針であり、日本人気を推薦根拠に使っていない。"
    - item: "Japan Context の独自性"
      result: "pass"
      note: "同時追加のzojirushi-vs-hydroflask-stanley-bottles.mdとは役割分担が維持されており重複なし。"
    - item: "Final Verdict 推薦偏り"
      result: "pass"
      note: "推薦根拠は仕様書から検証済みの事実に基づく。同シリーズの他記事はconditionalであり全体の偏りもない。"
    - item: "Amazon 開示表記"
      result: "pass"
      note: "開示対応はArticleLayout/BaseLayoutに委任されている（layout-dependent）。"
    - item: "変動する数値の断定"
      result: "pass"
      note: "星評価・レビュー件数・ランキング順位の断定なし。価格は時点付き・要確認フォームで統一。"
  summary: "全7項目がpass。禁止表現・LEVEL違反・日本人気ロジック・Japan Context重複・変動数値断定のいずれも検出されず。修正不要。"
ogImage: "/og/og-default.png"
products:
  - id: sm-khe36
    brand: "Zojirushi"
    award: "BEST FOR OFFICE AND DESK USE"
    ...
    specs:
      ...
      - label: "Dimensions"
        value: "2-5/8 x 2-7/8 x 7-3/8 in, per official specifications"
      - label: "Lid Type"
        value: "Flip-open lid, per manufacturer specifications"
    origin:
      brandCountry: "Japan"
      madeIn: null
  ...
  - id: sm-sf48
    brand: "Zojirushi"
    award: "BEST ONE-HAND OPERATION"
    name: "Zojirushi SM-SF48 One-Touch Stainless Mug (480 ml)"
    priceTier: "$"
    priceNote: "Under $40 based on listings reviewed (August 2026); verify current price on Amazon before purchasing"
    setContents: "Stainless mug + one-touch push-button lid, per manufacturer specifications"
    specs:
      - label: "Capacity"
        value: "480 ml / ~16.2 oz"
      - label: "Lid Type"
    ...
    origin:
      ...
      officialSeller: "Zojirushi brand store / authorized Amazon.com listings"
    usNotes:
      - "The push-button lid opens one-handed, useful for driving or carrying items in the other hand"
    whyPicked:
      - "One-touch lid is faster to open than a flip or screw design for repeated single-handed access"
      - "Mid-sized capacity balances all-day carry against a compact footprint"
    ratings:
      verifiedAt: "August 2026"
    amazon:
      url: "https://www.amazon.com/s?k=Zojirushi+SM-SF48+One+Touch+Stainless+Mug"
    ctaLabel: "Check on Amazon"

  - id: sx-ha89h
    brand: "Zojirushi"
    award: "BEST FOR COLD DRINKS"
    name: "Zojirushi SX-HA89H Stainless Tumbler with Straw (30 oz)"
    priceTier: "$"
    priceNote: "Under $45 based on listings reviewed (August 2026); verify current price on Amazon before purchasing"
    setContents: "Stainless tumbler + splash-proof lid + matching straw, per manufacturer specifications"
    specs:
      - label: "Capacity"
        value: "30 oz"
      - label: "Lid Type"
        value: "Splash-proof transparent lid with straw, per manufacturer specifications"
      - label: "Cold Retention"
        value: "Up to 31 hours icy cold, per manufacturer specifications"
    origin:
      brandCountry: "Japan"
      madeIn: null
      officialSeller: "Zojirushi brand store / authorized Amazon.com listings"
    usNotes:
      - "This is Zojirushi's straw-tumbler format, closer in use case to Stanley's Quencher line than to the brand's own mug lines"
      - "Wide top opening simplifies filling and cleaning, per manufacturer specifications"
    whyPicked:
      - "Largest capacity in the lines reviewed here, suited to all-day cold beverage carry"
      - "Straw format suits continuous sipping rather than occasional hot-drink pours"
    ratings:
      verifiedAt: "August 2026"
    amazon:
      url: "https://www.amazon.com/s?k=Zojirushi+SX-HA89H+Stainless+Tumbler+Straw"
    ctaLabel: "Check on Amazon"

  - id: sd-cs50
    brand: "Zojirushi"
    award: "BEST FOR ACTIVE USE"
    name: "Zojirushi SD-CS50 Direct Drinking Sports-Type Straw Bottle (0.52 L)"
    priceTier: "$"
    priceNote: "Under $35 based on listings reviewed (August 2026); verify current price on Amazon before purchasing"
    setContents: "Stainless bottle + pop-up straw lid, per manufacturer specifications"
    specs:
      - label: "Capacity"
        value: "0.52 L / ~17.6 oz"
      - label: "Lid Type"
        value: "Pop-up straw, deploys when lid opens, per manufacturer specifications"
    origin:
      brandCountry: "Japan"
      madeIn: null
      officialSeller: "Zojirushi brand store / authorized Amazon.com listings"
    ...
    ratings:
      verifiedAt: "August 2026"
    amazon:
      url: "https://www.amazon.com/s?k=Zojirushi+SD-CS50+Sports+Straw+Bottle"
    ctaLabel: "Check on Amazon"
japanContext:
  inJapan:
    - >-
...
- **Coffee or tea at a desk, opened occasionally:** SM-KHE mugs (flip-open lid, compact footprint)
- **Frequent one-handed access, driving or multitasking:** SM-SF mugs (one-touch push-button lid)
- **All-day cold drink, continuous sipping:** SX straw tumblers (splash-proof lid, largest capacity in this guide)
- **Workouts or active use:** SD sports-type bottles (pop-up straw, drink without tilting back)
