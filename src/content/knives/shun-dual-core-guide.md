...
researchSteps:
  - label: "Confirmed Dual Core's construction and pricing"
    detail: "Verified via shun.kaiusa.com official product pages that the Dual Core line uses an SG2/VG-MAX alternating steel construction with 71-layer Damascus cladding, and that the representative 8-inch kiritsuke model carries a $437 MSRP."
  - label: "Researched the kiritsuke blade shape's general use context"
    detail: "Reviewed multiple Japanese culinary and cutlery sources describing the kiritsuke shape's traditional association with a senior chef role in some professional kitchen contexts; treated as a pattern described across sources rather than a confirmed universal rule, since this could not be verified against a single authoritative primary source within this research scope."
  - label: "Compared Dual Core specifications against Shun Classic and Premier"
    detail: "Cross-referenced steel construction, layer count, and pricing across Shun's Classic, Premier, and Dual Core tiers to isolate what Dual Core's price premium specifically buys."
sourcesChecked:
...
reviewLog:
  ...
  checks:
    - item: "Evidence Strength Rule"
      result: "pass"
      note: "切付包丁と料理長/上位職の連関は LEVEL 2 として適切に処理。frontmatter japanContext.inJapan[0] および本文段落の両箇所で「複数ソースから観察されるパターン」「一次情報源での確認不可」「confirmed fact ではない」と明示。LEVEL 3・4 の無断断定なし。"
    - item: "禁止表現"
      result: "pass"
      note: "tested / hands-on / we tried / unboxed / in person / we found + 物理形容詞のいずれも本文・製品カードに存在しない。"
    - item: "日本で人気だからロジック"
      result: "pass"
      note: "verdict は conditional。japanContext は文化的・職業的文脈の説明に限定しており、「日本で人気 → 米国消費者へのおすすめ根拠」のロジックは一切使用されていない。"
    - item: "Japan Context の独自性"
      result: "pass"
      note: "既存Shun記事（kai-vs-shun, shun-classic-vs-premier, shun-vs-wusthof, shun-vs-miyabi, shun-vs-global）の japanContext を全件照合。切付包丁の職業的文化的文脈は既存記事に存在せず独自コンテンツ。"
    - item: "Final Verdict 推薦偏り"
      result: "pass"
      note: "verdict.rating は conditional。SG2/VG-MAX 交互コアの素材アップグレードが LEVEL 1 根拠として本文に明記されており、形状の適合確認を条件とする論拠も本文全体で展開されている。"
    - item: "Amazon 開示表記"
      result: "pass"
      note: "BaseLayout.astro フッターに「As an Amazon Associate, The Japan Filter earns from qualifying purchases.」が全ページ共通で表示されている（layout-dependent）。"
    - item: "変動する数値の断定"
      result: "pass"
      note: "具体的な星評価・レビュー件数・販売ランキングの断定なし。価格表記はすべて「at time of research (August 2026)」付きで適切に時点を明示。"
  summary: "全7項目が初回審査で pass。切付包丁の文化的主張は LEVEL 2 として正確に処理されており、禁止表現・変動数値・日本人気ロジックいずれも違反なし。"
ogImage: "/og/og-default.png"
products:
  - id: shun-dual-core-8in-kiritsuke
    brand: "Shun"
    award: "FLAGSHIP TIER"
    name: "Shun Dual Core 8-Inch Kiritsuke"
    priceTier: "$$$"
    priceNote: "MSRP $437; official site price $279.95 at time of research (August 2026)"
    setContents: "1 kiritsuke knife, per manufacturer specifications"
    specs:
      - label: "Steel"
        value: "Alternating SG2 and VG-MAX steel core, per manufacturer specifications"
      - label: "Construction"
    ...
    whyPicked:
      ...
      - "Confirmed alternating SG2/VG-MAX construction and 71-layer Damascus per official specifications"
    ratings:
      verifiedAt: "August 2026"
    amazon:
      url: "https://www.amazon.com/s?k=Shun+Dual+Core+8+Inch+Kiritsuke"
    ctaLabel: "Check on Amazon"

  - id: shun-classic-8in-chef-dualcore
    brand: "Shun"
    award: "STANDARD SHAPE, LOWER PRICE"
    ...
    specs:
      ...
      - label: "Blade Shape"
        value: "Standard Western chef's knife profile, per manufacturer specifications"
    origin:
      brandCountry: "Japan"
      madeIn: "Japan"
      officialSeller: "Kai USA Ltd. / authorized Amazon.com listings"
    usNotes:
      - "Standard chef's knife shape works with conventional Western cutting technique without adjustment, unlike the kiritsuke's angled tip"
    whyPicked:
      - "Reference point for buyers deciding whether Dual Core's price and shape are worth it over a standard, lower-cost Shun chef's knife"
    ratings:
      verifiedAt: "August 2026"
    amazon:
...
japanContext:
  inJapan:
    - >-
      ...
      this against a single authoritative primary source within this research scope,
      and the sources reviewed describe it as a cultural pattern rather than a
      formal or universal rule, so it should be read as a commonly described
  ...
  forUsBuyers:
    - >-
      Regardless of the shape's cultural associations in Japan, the practical
      question for a US buyer is whether an $437 knife with an unfamiliar blade
      profile and cutting motion is the right purchase compared to a standard
      chef's knife shape at a lower price point. A buyer without prior experience
      with a kiritsuke or similar angled-tip blade should expect an adjustment
      period, not immediate comfort.
    - >-
...
## Two Separate Upgrades in One Price Tag

Shun's Dual Core line costs significantly more than Classic or Premier, and that price increase comes from two distinct sources: a genuine steel and construction upgrade, and a specialized blade shape. It's worth separating the two before deciding whether the $437 MSRP is justified for a given kitchen.

## The Steel Upgrade Is Straightforward

Dual Core's alternating SG2 and VG-MAX steel core, wrapped in 71 layers of Damascus cladding, is a verifiable step up in construction complexity from Classic and Premier's single-core VG-MAX steel, per manufacturer specifications. This part of the price increase reflects genuine additional material and manufacturing complexity.
...
A cook who specifically wants both the steel upgrade and the kiritsuke shape gets a genuinely distinctive knife at this price point. A cook who wants the steel upgrade but is more comfortable with a standard chef's knife profile is better served checking whether Shun offers Dual Core's construction in other shapes, or stepping back to Premier's standard-shape, lower-priced tier.
