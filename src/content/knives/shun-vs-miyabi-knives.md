...
researchSteps:
  ...
  - label: "Confirmed Miyabi's ownership and manufacturing location"
    detail: "Cross-referenced multiple sources confirming Miyabi is manufactured at a Seki City facility owned by Zwilling J.A. Henckels, a German cutlery company, with production beginning in 2004."
  - label: "Compared steel and construction specifications for both brands' premium tiers"
    detail: "Reviewed official product specifications for Shun's VG-MAX-based lines against publicly available Miyabi specifications (SG2 and FC61 steel lines) to identify material differences."
  - label: "Checked US retail presence and pricing bands for both brands"
    detail: "Confirmed both brands maintain official US retail presence and reviewed their comparable price tiers for 8-inch chef's knives."
sourcesChecked:
...
reviewLog:
  ...
  checks:
    - item: "Evidence Strength Rule"
      result: "pass"
      note: "初期審査でLEVEL4推論（Zwillingの製造地選択の動機）が3箇所でラベルなし断定と判定。修正によりすべて「Based on available information」ラベルを付与し再審査pass。(1) japanContext.inJapan[1]、(2) japanContext.forUsBuyers[1]、(3) 本文「Why This Matters More Than It Sounds」節の3箇所を修正。"
    - item: "禁止表現"
      result: "pass"
      note: "tested/hands-on/we tried等の禁止表現なし。物理的体験を示す「we found」構文も確認されず。全文・製品カード説明を含め問題なし。"
    - item: "日本で人気だからロジック"
      result: "pass"
      note: "JapanContextはKAI法人とツヴィリングの企業所有構造という検証可能な事実に基づく。「日本で人気＝品質証拠」ロジックは一切使用されていない。"
    - item: "Japan Context の独自性"
      result: "pass"
      note: "ツヴィリングによるMiyabiブランドの所有構造は既存Shun記事（kai-vs-shun/shun-vs-wusthof/shun-classic-vs-premier/shun-vs-global/shun-vs-mac）に存在しない独自の視点。"
    - item: "Final Verdict 推薦偏り"
      result: "pass"
      note: "確認した全Shun比較記事がいずれも'conditional'verdict（warn相当）。本記事もconditionalだが、所有構造の違いとワランティ経路の差という具体的根拠が本文に存在する。根拠なしの推薦ではない。"
    - item: "Amazon 開示表記"
      result: "pass"
      note: "ProductCard.astroの各CTAボタン下に'(paid link)'表記あり（layout-dependent）。BaseLayout.astroのフッターに'As an Amazon Associate, The Japan Filter earns from qualifying purchases.'表記あり。"
    - item: "変動する数値の断定"
      result: "pass"
      note: "価格はMSRP/参考レンジ＋日付（August 2026）で表示。星評価・レビュー数・Amazon売上ランキングの断定的数値は使用されていない。"
  summary: "初期審査でCHECK-1（Evidence Strength Rule）がfail：Zwillingがセキ市で製造を選択した動機に関する3箇所の推論が、LEVEL4ラベルなしで事実として断定されていた。3箇所すべてに適切なラベルを付与して修正。その他6項目は初回からpass（Final Verdict推薦偏りはwarn相当）。"
ogImage: "/og/og-default.png"
products:
  - id: shun-classic-8in-chef-miyabi
    brand: "Shun"
    award: "JAPANESE-OWNED EXPORT BRAND"
    ...
    specs:
      ...
      - label: "Parent Company"
        value: "KAI Corporation (Japan), per official company materials"
      - label: "Made In"
    ...
    usNotes:
      - "Owned and developed by KAI Corporation, a Japanese company headquartered in Seki City where the knives are made"
    whyPicked:
      - "Represents the core Shun tier most comparable in price and category to Miyabi's mid-premium lines"
    ratings:
  ...
  - id: miyabi-birchwood-sg2-8in-chef
    brand: "Miyabi"
    ...
    specs:
      - label: "Steel"
        value: "SG2 powdered steel (varies by series), per manufacturer specifications"
      - label: "Construction"
        value: "Multi-layer Damascus cladding, per manufacturer specifications"
      - label: "Parent Company"
        value: "Zwilling J.A. Henckels (Germany), per company materials"
      - label: "Made In"
        value: "Seki City, Japan, at a Zwilling-owned facility since 2004, per multiple sources reviewed"
    origin:
      brandCountry: "Japan"
      madeIn: "Japan"
    ...
    ratings:
      verifiedAt: "August 2026"
    amazon:
      url: "https://www.amazon.com/s?k=Miyabi+SG2+8+Inch+Chef+Knife"
    ctaLabel: "Check on Amazon"
japanContext:
  inJapan:
    - >-
    ...
    - >-
      ...
      on Seki City's cutlery manufacturing tradition. Country of manufacture and
      country of corporate ownership are two different facts here, and neither
      brand's marketing prominently distinguishes between them.
  forUsBuyers:
    - >-
    ...
    - >-
      ...
      German and US corporate structure, not through KAI Corporation or Kai USA Ltd.
    - >-
      Steel and construction differences between the two brands are a more useful
      basis for a purchase decision than ownership alone: Shun's VG-MAX-based lines
      and Miyabi's SG2 or FC61-based lines are different steel formulations with
