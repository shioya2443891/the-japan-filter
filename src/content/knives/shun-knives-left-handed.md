...
researchSteps:
  ...
  - label: "Researched special-order availability for left-handed handles"
    detail: "Reviewed official Shun sourcing confirming left-handed handle versions are available only as a special order through authorized dealers, rather than as a standard stocked configuration."
  - label: "Compared this to broader Japanese knife handle conventions"
    detail: "Reviewed multiple sources on traditional Japanese single-bevel knife handles (D-shaped wa-handles), which are also commonly built handed by default, to understand whether Shun's approach reflects a broader industry pattern or a Shun-specific choice."
sourcesChecked:
...
reviewLog:
  ...
  checks:
    - item: "Evidence Strength Rule"
      result: "pass"
      note: "修正後、D型ハンドルの ergonomic claims はすべて LEVEL 2 ('tends to') または LEVEL 4 ('likely tradeoff, based on...') に適切に格下げされた。4箇所修正: intro / usBuyerNotes / 本文 / japanContext.forUsBuyers。"
    - item: "禁止表現"
      result: "pass"
      note: "tested / hands-on / we tried 等の禁止語は使用なし。'we' は japanContext の LEVEL 3 適切用法のみ。"
    - item: "日本で人気だからロジック"
      result: "pass"
      note: "Japan Context は和包丁の利き手別設計の歴史的文脈のみで、日本市場人気を US 推薦根拠にしていない。"
    - item: "Japan Context の独自性"
      result: "pass"
      note: "shun-classic-vs-premier.md と special-order 事実の重複あり。ただし本記事固有の視点（伝統的和包丁の利き手別設計との対比）が追加されており、コピーには該当しない。"
    - item: "Final Verdict 推薦偏り"
      result: "pass"
      note: "rating は 'conditional'。推薦根拠（special order 確認の必要性）は本文・製品カードで明示されている。"
    - item: "Amazon 開示表記"
      result: "pass"
      note: "ArticleLayout.astro に委ねられている（layout-dependent）。記事本文には affiliate / paid link の明示なし。"
    - item: "変動する数値の断定"
      result: "pass"
      note: "価格はすべて 'at time of research (August 2026)' 付き。星評価・レビュー数・ランキングの断定なし。"
  summary: "初回審査で CHECK-1 (Evidence Strength Rule) が fail。D型ハンドルの ergonomic claims 4か所（intro / usBuyerNotes / 本文 / japanContext.forUsBuyers）が LEVEL 4 推論を断定として記述していた。'tends to' 'likely tradeoff, based on...' 等のラベルを付与し、修正後全7項目 pass。"
ogImage: "/og/og-default.png"
products:
  - id: shun-kanso-8in-chef-lefthand
    brand: "Shun"
    award: "SYMMETRICAL-LEANING OPTION"
    name: "Shun Kanso 8-Inch Chef's Knife"
    priceTier: "$$"
    priceNote: "MSRP $181; official site price $144.95 at time of research (August 2026)"
    ...
    usNotes:
      - "Buyers should independently confirm handle shape and handedness with the retailer or official Shun materials before purchasing, since Shun's line configurations can change"
    whyPicked:
      - "Mid-tier price point worth checking directly against current handle specifications for left-handed suitability"
    ratings:
      verifiedAt: "August 2026"
    amazon:
      url: "https://www.amazon.com/s?k=Shun+Kanso+8+Inch+Chef+Knife"
    ctaLabel: "Check on Amazon"

  - id: shun-classic-8in-chef-lefthand
    brand: "Shun"
    award: "STANDARD HANDLE, SPECIAL-ORDER LEFT VERSION"
    ...
    specs:
      ...
      - label: "Handle"
        value: "D-shaped, right-handed by default; left-handed version available by special order through authorized dealers only, per official Shun sourcing"
    origin:
      brandCountry: "Japan"
      madeIn: "Japan"
      officialSeller: "Kai USA Ltd. / authorized Amazon.com listings"
    usNotes:
      - "Contact an authorized Shun dealer directly to inquire about special-order left-handed handle availability, cost, and lead time before purchasing"
    whyPicked:
      - "Represents Shun's most common line and the clearest example of the standard right-handed-default handle policy"
    ratings:
      verifiedAt: "August 2026"
    amazon:
...
japanContext:
  inJapan:
    - >-
      Shun's D-shaped handle was designed in 2002 specifically to accommodate a
      Western hand grip, as part of the brand's original export-market
      development, according to Shun's own brand materials. This was a deliberate
      design decision distinct from more traditional Japanese single-bevel knife
      handles.
    - >-
      Despite being designed for Western use generally, the D-shaped handle is
      built right-handed by default across Shun's product lines, per official
      product specifications reviewed. Left-handed versions are available only
      through special order via authorized dealers, not as a standard stocked
      configuration, per official Shun sourcing.
    - >-
      This handed-by-default approach echoes a pattern found in traditional
      Japanese single-bevel knives (used for tasks like sushi preparation), which
...
usBuyerNotes:
  - "Contact an authorized Shun dealer directly to confirm special-order left-handed handle availability, added cost, and lead time before purchasing"
  - "A standard right-handed D-shaped handle remains usable left-handed, but reduced comfort and control is a likely tradeoff, based on how D-shaped handle geometry is designed to fit one hand orientation"
  - "Check current handle specifications directly with the retailer, since Shun's line configurations and handle options can change over time"
